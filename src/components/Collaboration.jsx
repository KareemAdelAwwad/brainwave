    ...
    <Section crosses>
      <div className="container lg:flex">
        ...
        <div className="lg:ml-auto xl:w-[38rem] mt-4">
          <p className="body-2 mb-4 text-n-4 md:mb-14 lg:w-[22rem] lg:mx-auto ">
            {collabText}
          </p>
          ...
          border border-n-6 rounded-full -translate-x-1/2 scale-75 md:scale-100">
            ...
            <ul>
              {collabApps.map((app, index) => (
                <li key={index} className={`absolute top-0 left-1/2 h-1/2 -ml-[1.6rem]
                origin-bottom rotate-${index*45}`}>
                  <div className={`relative -top-[1.6rem] flex w-[3.2rem] h-[3.2rem]
                    bg-n-7 border border-n-1/50 rounded-xl -rotate-${index*45}`}>
                    <img
                    className="m-auto "
                      src={app.icon}
                      alt={app.title}
